...
import OTPModel from "../../components/otpModel/otpModel";
...
export default function VerticalLinearStepper({ name, stepData, today }) {
                ...
                <Button
                  ...
                  style={
                    buttonStyle === ind
                      ...
                      : { borderRadius: 20, backgroundColor: "#eff1f4" }
                  }
                  onClick={() => stepOneOnClick(ind, text)}
                  // labelColor={'#FFFFFF'}
                  // backgroundColor="#eff1f4"
                  variant={buttonStyle === ind ? "outlined" : ""}
                  borderStyle={1}
                >
                  <div
                ...
                {stepTwoData.map((text, ind) => (
                  <div className="p-1">
                    ...
                    <Button
                      ...
                      onClick={() => stepTwoOnClick(ind, text)}
                      // labelColor={'#FFFFFF'}
                      // backgroundColor="#eff1f4"
                      variant={buttonStyle2 === ind ? "outlined" : ""}
                      borderStyle={1}
                    >
                      <div
        ...
        <div className="pl-2">
          <form className={classes.container}>
            ...
            <DatePicker
              ...
              selected={startDate}
              onChange={(date) => {calculateToday(date); setStartDate(date)}}
              minDate={new Date()}
        ...
        <div className="pl-2">
          <div className="row">
            ...
            <div className="col-3 pt-2">
              <div className="DetailsPageMorningInFormData">MORNING</div>
            </div>
            <div className="col-8">
              <div className="row ">
                {["10:00 AM", "11:00 AM", "12:00 AM"].map((text, ind) => (
                  <div className="p-1">
                    {/* {console.log(ind, buttonStyle)} */}
                    <Button
                      // buttonStyle={{ borderRadius: 25 }}
                      ...
                      onClick={() => stepFourOnClick(ind, text, 10)}
                      // labelColor={'#FFFFFF'}
                      // backgroundColor="#eff1f4"
                      variant={buttonStyle3 === ind + 10 ? "outlined" : ""}
                      borderStyle={1}
                      disabled = {todayTime > ind + 10}
                    >
                      <div
                        className="FormsDetailsTextINButtons"
                        style={todayTime > ind + 10 ? { textTransform: "none", color : "#bbbdc0" } : { textTransform: "none" }}
                      >
                        {text}
                      </div>
                    </Button>
          ...
          <div className="row">
            ...
            <div className="col-3 pt-2">
              <div className="DetailsPageMorningInFormData">AFTERNOON</div>
            </div>
            <div className="col-8">
              <div className="row ">
                {["1:00 PM", "2:00 PM", "3:00 PM"].map((text, ind) => (
                  <div className="p-2">
                    {/* {console.log(ind, buttonStyle)} */}
                    <Button
                      // buttonStyle={{ borderRadius: 25 }}
                      ...
                      onClick={() => stepFourOnClick(ind, text, 20)}
                      // labelColor={'#FFFFFF'}
                      // backgroundColor="#eff1f4"
                      variant={buttonStyle3 === ind + 20 ? "outlined" : ""}
                      borderStyle={1}
                      disabled = {todayTime > ind + 20}
                    >
                      <div
                        className="FormsDetailsTextINButtons"
                        style={todayTime > ind + 20 ? { textTransform: "none", color : "#bbbdc0" } : { textTransform: "none" }}
          ...
          <div className="row">
            ...
            <div className="col-3 pt-2">
              <div className="DetailsPageMorningInFormData">EVENING</div>
            </div>
            <div className="col-8">
              <div className="row ">
                {["4:00 PM", "5:00 PM", "6:00 PM"].map((text, ind) => (
                  <div className="p-2">
                    {/* {console.log(ind, buttonStyle)} */}
                    <Button
                      // buttonStyle={{ borderRadius: 25 }}
                      ...
                      onClick={() => stepFourOnClick(ind, text, 30)}
                      // labelColor={'#FFFFFF'}
                      // backgroundColor="#eff1f4"
                      variant={buttonStyle3 === ind + 30 ? "outlined" : ""}
                      borderStyle={1}
                      disabled = {todayTime > ind + 30}
                    >
                      <div
                        className="FormsDetailsTextINButtons"
                        style={todayTime > ind + 30 ? { textTransform: "none", color : "#bbbdc0" } : { textTransform: "none" }}
      ...
      >
        {steps.map((label, index) => (
          <Step key={label}>
            <StepLabel>
              <div className="col">
                <div className="FormDetailsTitleStep p-2">{label}</div>
                {/* {activeStep} */}
