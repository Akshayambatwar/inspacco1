                                    ...
                                    > */}
                                        {/* <li>
                                            <div className="hoverWhite px-3 ">
                                                <div className="row ">
                                                    <Link href="/products/trueview-infrared-thermometer">
                                                        <div
                                                            className="pl-3 my-1"
                                                            style={{
                                                                fontFamily:
                                        ...
                                        {/* <li>
                                            <div className="hoverWhite px-3 ">
                                                <div className="row ">
                                                    <Link href="/products/foot-operated-sanitizing-stands">
                                                        <div
                                                            className="px-3 my-1 "
                                                            style={{
                                                                fontFamily:
